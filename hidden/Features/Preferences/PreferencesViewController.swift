...
class PreferencesViewController: NSViewController {
    ...
    private func updateEnginePreferenceUI() {
        ...
        if !nativeOffered && Preferences.menuBarEnginePreference == .native {
            ...
            enginePreferenceNote.stringValue = "Using Legacy spacer hiding (notch displays; inert on wide notchless externals). Native is recommended on direct builds.".localized
        }
    }
